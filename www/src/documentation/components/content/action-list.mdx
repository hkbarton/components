...
ActionList plays nicely with [Truncate](/components/text/truncate), when you wish to condense the table and keep all values to a single line.
...
;() => {
  ...
  return (
    <ActionList columns={columns}>
      <ActionListItem key="cheddar" id="cheddar">
        <ActionListItemColumn>Cheddar</ActionListItemColumn>
        <ActionListItemColumn>
          <Truncate>
      ...
      <ActionListItem key="parm" id="parm">
        <ActionListItemColumn>Parmesan</ActionListItemColumn>
        <ActionListItemColumn>
          <Truncate>
